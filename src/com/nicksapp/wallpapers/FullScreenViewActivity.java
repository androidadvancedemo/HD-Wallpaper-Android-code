...
import com.nicksapp.wallpapers.app.AppController;
import com.nicksapp.wallpapers.picasa.model.Wallpaper;
import com.nicksapp.wallpapers.util.Utils;
...
public class FullScreenViewActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		StartAppAd.init(FullScreenViewActivity.this, "103205820", "203170552");
		...
		AdBuddiz.cacheAds(FullScreenViewActivity.this);
		startAppAd.loadAd(); // load the next ad
		startAppAd.showAd(); // show the ad
		startAppAd.loadAd(); // load the next ad
		AdBuddiz.showAd(FullScreenViewActivity.this);
